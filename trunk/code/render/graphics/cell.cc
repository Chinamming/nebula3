...
*/
void
Cell::OnAttachToStage(const Ptr<Stage>& toStage)
{
...
*/
void
Cell::AttachEntity(const Ptr<GraphicsEntity>& entity)
{
...
*/
void
Cell::RemoveEntity(const Ptr<GraphicsEntity>& entity)
{
    n_assert(entity.isvalid());
...
*/
Ptr<Cell>
Cell::FindEntityContainmentCell(const Ptr<GraphicsEntity>& entity)
{
...
*/
void
Cell::InsertEntity(const Ptr<GraphicsEntity>& entity)
{
...
*/
void
Cell::RecurseUpdateLinks(const Ptr<GraphicsEntity>& observerEntity,
...
*/
void
Cell::UpdateLinks(const Ptr<GraphicsEntity>& observerEntity, uint observedEntityTypeMask, GraphicsEntity::LinkType linkType)
{
...
*/
void
Cell::UpdateNumEntitiesInHierarchy(GraphicsEntity::Type type, int num)
{
