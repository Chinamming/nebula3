...
namespace Win360
{
__ImplementClass(Win360::D3D9Texture, 'D9TX', Base::TextureBase);
...
D3D9Texture::SetupFromD3D9Texture(IDirect3DTexture9* tex2D)
{
    ...
    #else
        // Xbox360 allows casting between different texture classes
        this->d3d9BaseTexture = tex2D;
    #endif
...
D3D9Texture::SetupFromD3D9VolumeTexture(IDirect3DVolumeTexture9* texVolume)
{
    ...
    #else
        // Xbox360 allows casting between different texture classes
        this->d3d9BaseTexture = texVolume;
    #endif
