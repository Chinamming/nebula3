...
public:
    ...
    static cmpresult equal(const float4& v0, const float4& v1);
    /// perform near equal comparison with given epsilon
    static cmpresult nearequal(const float4& v0, const float4& v1, const float4& epsilon);
...
*/
__forceinline float4::cmpresult
float4::nearequal(const float4& v0, const float4& v1, const float4& epsilon)
{
    cmpresult res = 0;
