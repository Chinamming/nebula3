...
LoadMeshTest::Run()
{
    ...
    if (this->SetupRuntime())
    {
        ...
        Ptr<Mesh> mesh0 = this->resServer->CreateSharedResource(mesh1Name, Mesh::RTTI, StreamMeshLoader::RTTI).downcast<Mesh>();
        ...
        Ptr<Mesh> mesh1 = this->resServer->CreateSharedResource(mesh2Name, Mesh::RTTI, StreamMeshLoader::RTTI).downcast<Mesh>();
