        ...
        if (SQLITE_NULL != sqliteColumnType)
        {
            ...
            switch (this->valueTable->GetColumnValueType(valueTableColumnIndex))
            {
                ...
                case Attr::Float4Type:
                    {
                        ...
                        float4* ptr = (float4*) sqlite3_column_blob(this->sqliteStatement, resultColumnIndex);
                ...
                case Attr::Matrix44Type:
                    {
                        n_assert(SQLITE_BLOB == sqliteColumnType);
                        Math::matrix44* ptr = (Math::matrix44*) sqlite3_column_blob(this->sqliteStatement, resultColumnIndex);
                        int size = sqlite3_column_bytes(this->sqliteStatement, resultColumnIndex);
