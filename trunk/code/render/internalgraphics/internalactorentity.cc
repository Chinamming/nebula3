//------------------------------------------------------------------------------
//  internalactorentity.cc
//  (C) 2007 Radon Labs GmbH
//------------------------------------------------------------------------------
#include "stdneb.h"
#include "internalgraphics/internalactorentity.h"
...
/**
*/
InternalActorEntity::InternalActorEntity() :
    firstBaseAnim(true),
    nebCharacter(0),
    characterSet(0),
    clipScheduler(0),
...
*/
void
InternalActorEntity::OnActivate()
{
...
*/
void
InternalActorEntity::OnDeactivate()
{
...
*/
void
InternalActorEntity::ValidateCharacter()
{
...
*/
int
InternalActorEntity::GetNumAnimations() const
{
...
*/
void
InternalActorEntity::SetBaseAnimation(const String& animName, Time fadeIn, Time timeOffset, bool onlyIfInactive, bool waitForOverlayAnim, float randomValue)
{
...
*/
void
InternalActorEntity::SetOverlayAnimation(const String& animName, Time fadeIn, Time overrideDuration, bool onlyIfInactive, float randomValue)
{
    n_assert(animName.IsValid());
...
*/
void
InternalActorEntity::SetFadeAnimationMix(const Array<String>& names, const Array<float>& weights, Time fadeIn, Time overrideDuration, float randomValue)
{
...
*/
void
InternalActorEntity::SetAnimationMix(AnimationType animType, const Array<String>& animNames, const Array<float>& animWeights, Time fadeIn, Time timingInfo, float randomValue, bool waitForOverlayAnim)
{
    if (this->nebCharacter.isvalid())
    {
...
*/
void
InternalActorEntity::StopOverlayAnimation(Time fadeIn)
{
...
*/
void
InternalActorEntity::ActivateAnimations(AnimationType animType)
{
...
*/
void
InternalActorEntity::CommitAnimationChanges()
{
    if (this->nebCharacter.isvalid())
    {
...
*/
int
InternalActorEntity::GetJointIndexByName(const String& name)
{
...
*/
void
InternalActorEntity::EvaluateSkeleton(bool enforceEvaluation)
{
    if (0 != this->nebCharacter)
    {
        this->CommitAnimationChanges();
...
*/
CharJoint*
InternalActorEntity::GetJoint(int jointIndex) const
{
    if (0 != this->nebCharacter)
    {
...
*/
const matrix44&
InternalActorEntity::GetLocalJointMatrix(int jointIndex) const
{
    if (0 != this->nebCharacter)
    {
...
*/
void 
InternalActorEntity::SetupCharacter3Set()
{
...
*/
matrix44
InternalActorEntity::GetJointMatrixByIndex(IndexT jointIndex)
{
...
*/
matrix44
InternalActorEntity::GetJointMatrixByName(const String& jointName)
{
...
*/
void
InternalActorEntity::FadeAnimation(const String& anim, float targetWeight, Time fadeInTime, Time fadeOutTime, float randomValue, float runTime, float timeFactor, Time sampleTime, bool animRestart, bool fadeOutRunningAnims)
{
...
*/
void
InternalActorEntity::FadeAnimationMix(const Array<String>& anims, float targetWeight, Time fadeInTime, Time fadeOutTime, float randomValue, float runTime, float timeFactor, Time sampleTime, bool animRestart, bool fadeOutRunningAnims)
{
...
*/
void
InternalActorEntity::FadeAnimationMix(const Array<String>& anims, const Array<float>& targetWeights, Time fadeInTime, Time fadeOutTime, float randomValue, float runTime, float timeFactor, Time sampleTime, bool animRestart, bool fadeOutRunningAnims)
{
    n_assert(anims.Size() >= 1);
...
*/
void
InternalActorEntity::FadeRunningAnimationsOut()
{
    IndexT clipIndex;
...
*/
void
InternalActorEntity::FadeRunningAnimationsOut(AnimationType type, const Array<int>* clipFilter)
{
    ...
    {
        clipIndex = this->characterNode->GetClipIndexByName((*clipNames)[animIndex]);
...
*/
bool
InternalActorEntity::IsClipUsedByBaseAnimation(int clipIndex)
{
