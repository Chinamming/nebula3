...
public:
    ...
    virtual void Connect(Database* db, ConnectMode connectMode, bool ignoreUnknownColumn);
    ...
    virtual void BindValueTable(ValueTable* valueTable);
...
private:
    ...
    void BindValueToCommand(Command* cmd, IndexT wildcardIndex, IndexT valueTableColIndex, IndexT valueTableRowIndex);
