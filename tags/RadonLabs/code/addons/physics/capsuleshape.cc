...
namespace Physics
{
ImplementClass(Physics::CapsuleShape, 'PCSH', Physics::Shape);
...
CapsuleShape::RenderDebug(const Math::matrix44& parentTransform)
{
    if (this->IsAttached())
    {
        ...
        shapeRenderer->DrawShape(cap0Transform, CoreGraphics::ShapeRenderer::Sphere, color);
        ...
        shapeRenderer->DrawShape(cap1Transform, CoreGraphics::ShapeRenderer::Sphere, color);
        ...
        shapeRenderer->DrawShape(cylTransform, CoreGraphics::ShapeRenderer::Cylinder, color);
    }
}
