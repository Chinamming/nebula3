...
Float4Test::Run()
{
    ...
    this->Verify(float4::any(float4::less(v0, v1)));
    this->Verify(float4::any(float4::greater(v0, v1)));
    this->Verify(!float4::all(float4::less(v0, v1)));
    this->Verify(!float4::all(float4::greater(v0, v1)));
    this->Verify(float4::all(float4::lessequal(v0, v2)));
    this->Verify(float4::all(float4::greaterequal(v2, v0)));
}
