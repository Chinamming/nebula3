...
{
    n_assert(this->inBeginBodies);
    n_assert(this->bodyArray.Size() == (uint)this->curBodyIndex);
...
{
    for (uint i = 0; i < bodyArray.Size(); i++)
    {
...
{
    n_assert(this->inBeginJoints);
    n_assert(this->jointArray.Size() == (uint)this->curJointIndex);
...
{
    n_assert(this->inBeginShapes);
    n_assert(this->shapeArray.Size() == (uint)this->curShapeIndex);
