#pragma once
#ifndef GRAPHICS_ACTORENTITY_H
#define GRAPHICS_ACTORENTITY_H
//------------------------------------------------------------------------------
/**
    @class Graphics::ActorEntity
  
    An actor graphics entity. NOTE: The current ActorEntity class is
...
namespace Graphics
{
class ActorEntity : public ModelEntity
{
    DeclareClass(ActorEntity);
public:
    enum AnimationType
    {
        BaseAnim,
...
inline
void
ActorEntity::SetAnimationMapping(const Util::String& name)
{
...
inline
const Util::String&
ActorEntity::GetAnimationMapping() const
{
...
inline
void
ActorEntity::SetSkinList(const Util::String& s)
{
    this->skinList = s;
}
//------------------------------------------------------------------------------
...
inline
bool
ActorEntity::IsOverlayAnimationActive() const
{
...
inline
Util::String
ActorEntity::GetOverlayAnimation() const
{
...
inline
Util::String
ActorEntity::GetBaseAnimation() const
{
...
inline
Util::String
ActorEntity::GetOverlayClip() const
{
...
inline
Timing::Time
ActorEntity::GetOverlayAnimationDuration() const
{
...
inline
Timing::Time
ActorEntity::GetBaseAnimationDuration() const
{
...
inline
Char::Character*
ActorEntity::GetCharacterPointer() const
{
...
inline
bool
ActorEntity::HasCharacter3Set() const
{
...
inline
Char::CharacterSet*
ActorEntity::GetCharacter3Set() const
{
...
*/
inline
Anim::AnimClipScheduler*
ActorEntity::GetAnimClipScheduler() const
{
...
ActorEntity::GetCharacterNode() const
{
