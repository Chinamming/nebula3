...
*/
void
Sqlite3Table::Connect(Database* db, ConnectMode connectMode, bool ignoreUnknownColumns)
{
...
*/
void
Sqlite3Table::BindValueTable(ValueTable* valTable)
{
    if (this->IsConnected())
    {
...
*/
void
Sqlite3Table::BindValueToCommand(Command* cmd, IndexT wildCardIndex, IndexT valueTableColIndex, IndexT valueTableRowIndex)
{
    n_assert(this->valueTable.isvalid());
