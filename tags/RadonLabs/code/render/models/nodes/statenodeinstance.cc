...
*/
void
StateNodeInstance::OnAttachToModelInstance(const Ptr<ModelInstance>& inst, const Ptr<ModelNode>& node, const Ptr<ModelNodeInstance>& parentNodeInst)
{
...
*/
void
StateNodeInstance::OnRemoveFromModelInstance()
{
